...
- `WORLD = { WIDTH: 960, HEIGHT: 540, ROOF_Y: 430, SOFT_EDGE_L: 72, SOFT_EDGE_R: 888, PLAYER_START_X: [280, 680], HURTBOX_W: 50, HURTBOX_H: 98 }`
  (13.00: the hurtbox was 72 × 140 at the 150 px body; every body-relative number is now × 0.7, see `13-art/00`)
- `BALANCE = { MAX_HP: 40, PUNCH_DAMAGE: 12, CHIP_DAMAGE: 3, PUNCH_STARTUP: 4, PUNCH_ACTIVE: 3, PUNCH_RECOVERY: 8, PUNCH_GAP: 10, PUNCH_REACH: 70, PUNCH_HITBOX_TOP: 120, PUNCH_HITBOX_H: 60, HITSTUN_TICKS: 12, KNOCKBACK_PX: 144, WALK_SPEED: 3, JUMP_VELOCITY: -9.1, GRAVITY: 8/30, JUMP_IFRAME_START: 3, JUMP_IFRAME_END: 10, OOB_DAMAGE: 3, OOB_EVERY_TICKS: 30 }`
